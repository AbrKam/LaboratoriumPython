...
#e) Napisz program, który na początku każdego elementu listy doda literę a, a na końcu literę z. Np. [‘csae’, ‘eg’, ‘rr’] -> [‘acsaez’, ‘aegz’, ‘arrz’]

nowe = []

for i in lElementow: #iterujemy przez każdy element w liście
    j = 'a'+i+'z' #z wykorzystaniem konkantenacji dodajemy do każdego zdania a na początku i z na końcu
    nowe.append(j) #dodajemy nowe powstałe w wyniku sklejenia zdanie do nowej listy
    
print(f'Z dodaniem a na początku każdego zdania i z na końcu: {nowe}')